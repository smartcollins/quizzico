    ...
    <div>
      <section className="flex w-full justify-center h-screen pt-5">
       ...
       <DiscoverHeader caption={"Discover"}/>
          ...
          slide2={<CarouselSections headerOne={"Great Ideas comes"} headerTwo={"from brilliant mindset"} title={"Alfonzo Schuesster"} image={Sliders[1]}/>}
          slide3={<CarouselSections headerOne={"up ideas, worth"} headerTwo={"greater height to attain"} title={"John Romauld" } image={Sliders[4]}/>}
          />
       </div>
        <div>
        ...
        <HomeCarousel 
          slide1={<CarouselSections headerOne={"Get smater with"} headerTwo={"productive quizzico"} title={"Titus Katmura"} image={Sliders[3]}/>}
