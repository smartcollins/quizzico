    ...
    <div className="my-4">
      ...
      {option ? (
        <div className="flex items-center justify-between  border-gray-400 border-b-2">
          ...
          {pass ? (
            <EyeSlash size={20} color="#6949ff" weight="fill" />
          ) : (
        ...
        <input
          type={type}
          className=" border-gray-400 border-b-2 outline-none w-full placeholder:capitalize placeholder:text-xl placeholder:font-semibold p-2"
